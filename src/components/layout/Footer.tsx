...
const productLinks = [
  ...
  { label: "Escrow Engine", href: "/products" },
  { label: "Dashboard", href: "/products" },
  { label: "API Infrastructure", href: "/products" },
  { label: "Compliance Tools", href: "/products" },
];
...
export default function Footer() {
  return (
    <footer className="bg-primary-900 text-white">
      {/* Gradient top line */}
      <div className="h-1 bg-gradient-to-r from-primary-500 via-accent-green to-primary-500" />
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex gap-4">
              {["linkedin", "twitter", "facebook"].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-10 h-10 rounded-full bg-primary-800 flex items-center justify-center text-primary-300 hover:bg-primary-700 hover:text-white transition-colors"
                  aria-label={social}
                >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-200">
              ...
              <li>{SITE_CONFIG.founder}</li>
              <li>{SITE_CONFIG.founderTitle}</li>
            </ul>
          </div>
        </div>
      </Container>
